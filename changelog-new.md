...
> [!WARNING]
> Starting SDK version 5.2.0; the SDK will be available via the Unity package manager, please read the [Upgrade Guide](upgradeUnitySDK.md)
...
Latest Gamedock android sdk dependency added
